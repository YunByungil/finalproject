...
public class JoaMyPagePayMovieDTO {
	public JoaMyPagePayMovieDTO() {
	...
	public JoaMyPagePayMovieDTO(int payMov_idx, int payMov_the_idx, String payMov_sch_theater, String payMov_mem_id,
