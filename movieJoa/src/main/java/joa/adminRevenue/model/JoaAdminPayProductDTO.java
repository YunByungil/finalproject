...
public class JoaAdminPayProductDTO {
	
	private int payPro_idx;
	...
	public JoaAdminPayProductDTO() {
		// TODO Auto-generated constructor stub
	}

	public JoaAdminPayProductDTO(int payPro_idx, String payPro_mem_id, String payPro_mem_name, String payPro_mem_email,
			String payPro_mem_tel, String payPro_pg, String payPro_method, String payPro_pro_name, int payPro_price_sum,
			int payPro_discount, int payPro_total_price, String payPro_merchant_uid, Date payPro_date) {
		super();
		this.payPro_idx = payPro_idx;
	...
	public int getPayPro_idx() {
		return payPro_idx;
	}

	public void setPayPro_idx(int payPro_idx) {
		this.payPro_idx = payPro_idx;
	}
