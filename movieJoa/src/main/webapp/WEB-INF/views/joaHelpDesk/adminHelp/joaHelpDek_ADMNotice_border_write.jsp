...
<div class="manyHelpMain">
	<h4 class="manyHelpSubject">공지게시판 - 게시글 작성</h4> <div align="right"><input type="submit" value="게시글 작성" class="writebutton" ></div>
	<div class="manyHelpIntroduce">공지 게시판 작성페이지입니다.<br>
	...
	<div class="manyHelpWrite">
		<table align="center" class="manyHelpWriteFeild">
			...
			<tr>
			<th>제목</th>
			<td colspan="6"><input type="text" name="ntc_subject" id="lfq_subject"></td>
			</tr>
			<tr>
			<td colspan="7"><hr></td>
			</tr>
			<tr>
				<th>내용</th>
				<td colspan="6"><textarea rows="31" cols="76" name="ntc_content"></textarea></td>
			</tr>
			<tr>
