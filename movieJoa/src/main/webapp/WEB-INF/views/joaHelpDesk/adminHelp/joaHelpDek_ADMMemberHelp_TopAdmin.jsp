...
<script>
	...
	function categoryChange(e) {
	  var seoul = ['전체선택','강남점', '역삼점', '삼성점', '신사점', '청담점', '압구정점', '잠실점', '강동점',
          '명동점', '중구점', '서울역점', '이태원점', '종로점', '인사동점','홍대점', '서대문점',
          '영등포점', '구로점', '신도림점'];
	  var incheon = ['전체선택','송도점', '인천국제공항점' '강화점', '을왕리점', '영종점'];
	  var gyeonggi = ['전체선택','가평점', '청평점', '양평점', '수원점', '화성점', '고양점', '파주점', '김포점', '의정부점', '포천점', '동두천점'];
	  var gangwon = ['전체선택','속초점', '양양점', '고성점', '춘천점', '인제점', '철원점', '강릉점', '평창점', '영월점'];
