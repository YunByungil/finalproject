...
<form name="addEventForm" action="addEvent.do" method="post"  enctype="multipart/form-data">
...
<tr>
	...
	<td colspan="3" class="td_basic"><input type="text" name="eve_subject" class="input_text_basic" placeholder="이벤트 제목을 입력해주세요."></td>
</tr>
<tr>
