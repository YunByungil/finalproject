...
<form:form modelAttribute="eo" name="updateEventForm" method="post" action="updateEvent.do" enctype="multipart/form-data">
...
<tr>
	...
	<form:input path="eve_subject" type="text" name="eve_subject" class="input_text_basic" placeholder="이벤트 제목을 입력해주세요" value="${dto.eve_subject }"/><br>
	<form:errors path="eve_subject" class="error_span"/></td>
</tr>
<tr>
