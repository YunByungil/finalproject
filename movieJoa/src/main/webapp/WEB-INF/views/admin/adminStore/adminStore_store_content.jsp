...
<div class="mainBox">
<div class="div_title"><h2 class="title">| 상품정보</h2></div>
<form name="editProductForm" action="editProduct.do" method="post" enctype="multipart/form-data"> 
<div class="table_wrap">
<table class="main_table">
<tr>
	<th class="th_basic">상품명</th>
	<td colspan="3" class="td_basic"><input type="text" name="pro_name" class="input_text_title" placeholder="상품명을 입력해주세요." value=""></td>
</tr>
<tr>
	<th class="th_basic">가격</th>
	<td class="td_basic"><input type="text" name="pro_price" class="input_text_director" placeholder="5,000" value=""></td>
</tr>
<tr>
...
<tr>
	...
	<td class="td_basic"><textarea rows="10" cols="45" name="pro_info" placeholder="상품소개를 입력해주세요." value=""></textarea></td>
</tr>
<tr>
	...
	<div class="btn_wrap"><input type="button" value="돌아가기" class="button_sub"><input type="submit" value="정보변경" class="button_main"></div>
</form>
</div>
</body>
</html>