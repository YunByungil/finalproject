...
<form action="adminRegisterForm.do" method="post" class="joinForm">  
<h2>관리자 등록</h2>                                                                                           
      <div class="textForm">
        <input name="admin_id" type="text" class="id" placeholder="아이디" value="admin_"></input>
      </div>
      <div class="textForm">
      ...
      <div class="textForm">
        <input name="admin_name" type="text" class="name" placeholder="이름">
      </div>
       <div class="textForm">
        <input name="admin_area" type="text" class="area" placeholder="지역">
      </div>
      <div class="textForm">
        <input name="admin_shop" type="text" class="shop" placeholder="지점">
      </div>
      <div class="textForm">
